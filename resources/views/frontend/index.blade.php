    ...
    <main id="main">
        ...
        <section class="section-services section-t8">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card-box-c foo" style="margin-bottom:4rem!important;">
                            <div class="card-header-c d-flex">
                                <div class="card-box-ico">
                                    <span class="bi bi-cart"></span>
                                </div>
                                <div class="card-title-c align-self-center">
                                    <h3 class="">House <span class="color-b">Cleaning</span></h3>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card-box-c foo">
                            <div class="card-header-c d-flex">
                                ...
                                <div class="card-title-c align-self-center">
                                    <h3 class="">Deep<span class="color-b"> Cleaning</span></h3>
                                </div>
                            </div>
                            <div class="card-body-c">
                                <p class="content-c">
                    ...
                    <div class="col-md-4">
                        <div class="card-box-c foo">
                            <div class="card-header-c d-flex">
                                ...
                                <div class="card-title-c align-self-center">
                                    <h3 class="">Documentation<span class="color-b"> Service</span></h3>
                                </div>
                            </div>
                            <div class="card-body-c">
                                <p class="content-c">
                    ...
                    <div class="col-md-4">
                        <div class="card-box-c foo">
                            <div class="card-header-c d-flex">
                                ...
                                <div class="card-title-c align-self-center">
                                    <h3 class="">Rent<span class="color-b">& Operations</span></h3>
                                </div>
                            </div>
                            <div class="card-body-c">
                                <p class="content-c">
                    ...
                    <div class="col-md-4">
                        <div class="card-box-c foo">
                            <div class="card-header-c d-flex">
                                ...
                                <div class="card-title-c align-self-center">
                                    <h3 class="">House<span class="color-b"> Maintainance</span></h3>
                                </div>
                            </div>
                            <div class="card-body-c">
                                <p class="content-c">
                    ...
                    <div class="col-md-4">
                        <div class="card-box-c foo">
                            <div class="card-header-c d-flex">
                                ...
                                <div class="card-title-c align-self-center">
                                    <h3 class="">Guard<span class="color-b"> & CCTV</span></h3>
                                </div>
                            </div>
                            <div class="card-body-c">
                                <p class="content-c">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="testimonials-content">
                                            <p class="testimonial-text">
                                                ...
                                                ea nam praesentium debitis hic ber quibusdam voluptatibus officia expedita
                                                corpori.
                                            </p>
                                        </div>
